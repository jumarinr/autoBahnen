...
export const ReadSedes = new ValidatedMethod({
  ...
  validate: () => {},
  run() {
    /* SELECT codigo, nombre, SEDE.direccion as direccion, municipio, SEDE.telefono as telefono, SEDE.email as email, EMPLEADO.nombre_completo as gerente
       FROM SEDE, CLIENTE
      ...
      dataBaseConnection
        .select(
          dataBaseConnection.raw(
            "codigo, nombre, SEDE.direccion as direccion, municipio, SEDE.telefono as telefono, SEDE.email as email, EMPLEADO.nombre_completo as gerente"
          )
        )
