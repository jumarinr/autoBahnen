...
export default class EditVenta extends React.Component {
  ...
  llenarDatos(event) {
    if (!this.state.codigo) {
      this.setState({
        openError: true,
        msgError: "Debe ingresar una código de venta"
      });
      return false;
    }
    if (!this.state.clienteCedula) {
      this.setState({
        openError: true,
        msgError: "Debe seleccionar la cedula del cliente"
      });
      return false;
    }
    if (!this.state.empleadoCedula) {
      this.setState({
        openError: true,
        msgError: "Debe seleccionar la cedula del vendedor"
      });
      return false;
    }
    const data = {
                    ...
                    <form onSubmit={event => this.llenarDatos(event)}>
                      ...
                      <Grid item xs={12}>
                        ...
                        <Select
                          ...
                          onChange={event =>
                            this.setState({
                              empleadoCedula: event.target.value
                            })
                          }
                          inputProps={{
                            name: "Cliente",
                        ...
                        >
                          {this.state.empleados.map(empleado => (
                            <MenuItem value={empleado.cedula}>
                      ...
                      <Grid item xs={12}>
                        ...
                        <Select
                          ...
                          onChange={event =>
                            this.setState({ clienteCedula: event.target.value })
                          }
                          inputProps={{
                            name: "Cliente",
                            fullWidth: true,
